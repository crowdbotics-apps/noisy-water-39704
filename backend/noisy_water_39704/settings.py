"""
Django settings for noisy_water_39704 project.
...
ROOT_URLCONF = 'noisy_water_39704.urls'
...
WSGI_APPLICATION = 'noisy_water_39704.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_water_39704 API",
    "DESCRIPTION": "API documentation for noisy_water_39704 App",
    "VERSION": "v1",
}
